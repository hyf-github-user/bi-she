...
from django_vue_element_admin.myapps.monitor.models import ErrorLogs
from django_vue_element_admin.myapps.monitor.serializers.error import ErrorLogsSerializer
