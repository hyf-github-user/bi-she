        ...
        >
          ...
          >
            <template slot-scope="{row}">
              <el-button v-permission="['admin']" type="primary" icon="el-icon-edit" size="mini" @click="lockUser(row)">锁定</el-button>
              <el-button v-permission="['admin']" type="danger" icon="el-icon-delete" size="mini" @click="blackIP(row)">拉黑IP</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!--分页组件-->
