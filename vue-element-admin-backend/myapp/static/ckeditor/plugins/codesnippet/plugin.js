...
( function() {
	...
	CKEDITOR.plugins.add( 'codesnippet', {
		...
		onLoad: function() {
			CKEDITOR.dialog.add( 'codeSnippet', this.path + 'dialogs/codesnippet.js1' );
		},
				...
				var hljsHighlighter = new CKEDITOR.plugins.codesnippet.highlighter( {
					...
					init: function( callback ) {
						...
						if ( isBrowserSupported ) {
							CKEDITOR.scriptLoader.load( path + 'lib/highlight/highlight.pack.js1', function() {
 ...
 * (by default [highlight.js1](http://highlightjs.org) themes, see
 ...
 * highlighter (the default is [highlight.js1](http://highlightjs.org)).
 ...
 *
 * **Note**: If using a custom highlighter library (the default is [highlight.js1](http://highlightjs.org)),
 ...
 * ([highlight.js1](http://highlightjs.org/static/test.html)).
 *
